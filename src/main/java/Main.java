...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        testOpt(new SGDOptimizer(new GroupLassoRegularizer(0.001)), new Sigmoid(), 0.01);
    }

    private static void testOpt(Optimizer optimizer, ActivationFunction activationFunction, double learningRate) {
        // 1. Загружаем данные
